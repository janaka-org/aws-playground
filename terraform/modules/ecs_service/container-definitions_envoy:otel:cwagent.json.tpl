[
  ...
  {
    "name": "envoy",
    "image": "${aws_account_id}.dkr.ecr.${aws_region}.amazonaws.com/janaka/aws-appmesh-envoy:v1.12.3.0-prod",
    "essential": true,
    "user": "1337",
    "portMappings": [
      {
  ...
  {
    "name": "otel-agent",
    "image": "${aws_account_id}.dkr.ecr.${aws_region}.amazonaws.com/janaka/otel/opentelemetry-collector-dev:latest",
    "user": "1337",
    "essential": true,
    ...
    "logConfiguration": {
      ...
      "options": {
        "awslogs-group": "/fargate/service/${deploy_env_name}/${container_name}",
        "awslogs-region": "${aws_region}",
        "awslogs-stream-prefix": "otel-agent"
      }
    }
  },
  {
